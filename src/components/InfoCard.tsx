...
export function InfoCard() {
  return (
    <div className="bg-gradient-to-br from-cyan-50 to-teal-50 rounded-xl shadow-xl p-6 sm:p-8 border-2 border-cyan-200 animate-slideUp">
      <div className="flex items-start gap-4 mb-6">
        <div className="flex-shrink-0">
          <BookOpen size={24} className="text-cyan-600 mt-1" />
        </div>
        <div>
      ...
      <div className="space-y-4">
        <div className="flex gap-4">
          <div className="flex-shrink-0 w-8 h-8 bg-cyan-600 text-white rounded-full flex items-center justify-center text-sm font-semibold">1</div>
          <div>
        ...
        <div className="flex gap-4">
          <div className="flex-shrink-0 w-8 h-8 bg-cyan-600 text-white rounded-full flex items-center justify-center text-sm font-semibold">3</div>
          <div>
        ...
        <div className="flex gap-4">
          <div className="flex-shrink-0 w-8 h-8 bg-cyan-600 text-white rounded-full flex items-center justify-center text-sm font-semibold">4</div>
          <div>
      ...
      <div className="mt-6 pt-6 border-t border-cyan-200">
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="bg-white rounded-lg p-3 text-center shadow-sm">
            <p className="text-2xl font-bold text-cyan-600">93-103%</p>
            <p className="text-xs text-slate-600 mt-1">Target Range</p>
          </div>
          <div className="bg-white rounded-lg p-3 text-center shadow-sm">
            <p className="text-2xl font-bold text-cyan-600">Real-time</p>
